...
class DSAListNodeTest(unittest.TestCase):
    """ This class is copied from my submission for DSA Practical 04 - Linked Lists"""
    def setUp(self):
        self.testNode = dataStructures.DSAListNode('abc')  # create a node object

    def test_constructor(self):
        self.assertEqual('abc', self.testNode.value)


class DSALinkedListTest(unittest.TestCase):
    """ This class is copied from my submission for DSA Practical 04 - Linked Lists"""
    def setUp(self):
        self.ll = dataStructures.DSALinkedListDE()  # create a list object for all tests
    ...
    def test_insertFirst(self):
        ...
        self.assertEqual('xyz', self.ll.removeFirst())
        self.assertEqual('jkl', self.ll.removeFirst())
        self.assertEqual('abc', self.ll.removeFirst())
    ...
    def test_insertLast(self):
        ...
        self.assertEqual('xyz', self.ll.removeLast())
        self.assertEqual('jkl', self.ll.removeLast())
        self.assertEqual('abc', self.ll.removeLast())

    def test_peekFirst(self):
        self.ll.insertFirst('a')
        self.assertEqual('a', self.ll.peekFirst())

        self.ll.insertFirst('b')
        self.assertEqual('b', self.ll.peekFirst())

        self.ll.removeFirst()
        self.ll.removeFirst()
        with self.assertRaises(ValueError):  # assertRaises work better in a with statement
            self.ll.peekFirst()

    def test_peekLast(self):
        self.ll.insertFirst('c')
        self.ll.insertFirst('b')
        self.ll.insertFirst('a')

        self.assertEqual('c', self.ll.peekLast())

        self.ll.removeLast()
        self.assertEqual('b', self.ll.peekLast())
    ...
    def test_isEmpty(self):
        ...
        self.ll.insertFirst('abc')
        self.assertEqual(False, self.ll.isEmpty())
    ...
    def test_removeFirst(self):
        ...
        self.assertEqual('a', self.ll.removeFirst())
        self.assertEqual('b', self.ll.removeFirst())

    def test_removeLast(self):
        with self.assertRaises(ValueError):
            self.ll.removeLast()

        self.ll.insertLast('a')
        self.ll.insertLast('b')

        self.assertEqual('b', self.ll.removeLast())
        self.assertEqual('a', self.ll.removeLast())

    def test__iter__(self):
        self.ll.insertLast('a')
        self.ll.insertLast('b')
        self.ll.insertLast('c')

        llAsList = []
        for value in self.ll:
            llAsList.append(value)
        self.assertEqual(['a', 'b', 'c'], llAsList)
    ...
    def test__next__(self):
        ...
        myIter = iter(self.ll)
        self.assertEqual(1, next(myIter))
        self.assertEqual(2, next(myIter))
        self.assertEqual(3, next(myIter))
        with self.assertRaises(StopIteration):  # assertRaises work better in a with statement
            next(myIter)
